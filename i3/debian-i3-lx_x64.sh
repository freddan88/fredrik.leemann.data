...
install_all() {
  ...
  apt update -qq
  apt install lxpanel lxterminal lxappearance lxrandr pcmanfm xscreensaver xbacklight numlockx notification-daemon policykit-1 xorg i3 rofi stacer gimp mirage -y
  ...
  apt install libapache2-mpm-itk openssl sqlite3 docker-ce docker-ce-cli containerd.io -y
