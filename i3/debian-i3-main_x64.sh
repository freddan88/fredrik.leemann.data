...
install_all() {
  ...
  apt update -qq
  apt install i3 i3status picom suckless-tools rofi playerctl xbacklight numlockx unclutter zsh bzip2 zip unzip nano vim lshw lshw-gtk htop xterm dos2unix ftp tftpd-hpa -y
