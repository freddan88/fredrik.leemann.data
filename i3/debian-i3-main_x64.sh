...
install_all() {
  ...
  apt update -qq
  apt install i3 i3status suckless-tools rofi playerctl xbacklight numlockx unclutter neofetch nitrogen zsh bzip2 zip unzip nano ffmpeg lshw htop samba libpcre3 -y
  apt install ufw gufw openssl sqlite3 fail2ban ffmpeg gimp mirage stacer synaptic thunderbird libreoffice ghostscript debian-edu-artwork gnome-icon-theme kazam vlc -y
